 ...
 */
public abstract class KmsAsymmetricECDSAProvider extends BaseJWSProvider {
    ...
    /**
     * The supported JWS algorithms (alg) by the ECDSA provider class.
     *
    ...
    protected KmsAsymmetricECDSAProvider(
